          ...
          <div className="flex items-center justify-between pb-4 mb-5 border-b border-[#1f2740]/80">
            ...
            >
              <img
                ...
                alt="Rota Group"
                className="h-12 w-auto max-h-12 object-contain transition-all duration-200 group-hover:scale-105 active:scale-95 filter drop-shadow-[0_2px_10px_rgba(24,214,236,0.2)]"
              />
            </Link>
            <button
              type="button"
              onClick={fecharMenu}
              className="rounded-lg p-1.5 text-[#8fa3c7] hover:text-[#f5f7fc] hover:bg-[#1a2238] md:hidden transition-colors"
        ...
        <header className="sticky top-0 z-20 border-b border-[#1f2740] bg-[#121622]/95 backdrop-blur-sm"><div className="flex min-h-16 h-auto flex-wrap items-center justify-between gap-3 px-5 py-2 pl-16 md:px-8">
          ...
          <div className="flex shrink-0 items-center gap-2.5">
            ...
            <button
              ...
              className="hidden rounded-xl p-2 text-[#8fa3c7] hover:text-[#f5f7fc] hover:bg-[#1a2238] transition-colors sm:block"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex items-center gap-2 pl-1">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-[#2e59f6]/30 to-[#18d6ec]/20 border border-[#2e59f6]/40 text-xs font-bold text-[#18d6ec]">
                {usuario?.nome?.[0]?.toUpperCase() ?? 'U'}
              </span>
              <span className="hidden text-xs font-medium text-[#c5d3ea] lg:block">
                {usuario?.nome}
              </span>
            </div>
            <button
              ...
              title="Sair"
              aria-label="Sair da conta"
              className="rounded-xl p-2 text-[#8fa3c7] hover:text-[#ef4444] hover:bg-[#ef4444]/10 transition-colors"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" />
                <polyline points="16 17 21 12 16 7" />
