...
export default function ProjetoContextBar({ projetoId, onNomeCarregado }: { projetoId: string | number; onNomeCarregado?: (nome: string | null) => void }) {
