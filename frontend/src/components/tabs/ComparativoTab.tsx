  ...
  return (
    <div>
      <div className="grid grid-cols-4 gap-4 mb-4">
        <KpiCard rotulo="Locais" valor={String(t.num_locais)} sub={`${t.num_itens} itens no total`} cor="#1E40AF" />
        <KpiCard rotulo="Receita mensal" valor={fmtMoeda(t.receita_mensal)} sub="Somada dos locais" cor="#3B82F6" atraso={60} />
        <KpiCard rotulo="Saldo mensal" valor={fmtMoeda(t.saldo_mensal)} sub="Somada dos locais" cor="#16A34A" atraso={120} />
        <KpiCard rotulo="Investimento" valor={fmtMoeda(t.investimento)} sub="Mão de obra + equipamento" cor="#D97706" atraso={180} />
      </div>
      <div className="grid grid-cols-4 gap-4 mb-2">
        <KpiCard rotulo="Receita anual" valor={fmtMoeda(t.receita_anual)} sub="12 meses + taxas" cor="#0EA5E9" atraso={240} />
        <KpiCard rotulo="Equipamento" valor={fmtMoeda(t.equipamento)} sub="Itens da proposta" cor="#8B5CF6" atraso={300} />
        <KpiCard rotulo="Mão de obra" valor={fmtMoeda(t.mao_de_obra)} sub="Instalação" cor="#EC4899" atraso={360} />
        <KpiCard rotulo="Retorno médio" valor={retornoMedioFinal !== null ? fmtNumero(retornoMedioFinal) : '—'} sub="Payback médio dos locais" cor="#DC2626" atraso={420} />
      </div>
